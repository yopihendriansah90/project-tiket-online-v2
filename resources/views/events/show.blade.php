...
<body class="font-sans antialiased bg-gray-50 text-gray-800">
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <!-- Event Poster -->
            <div class="h-96 bg-cover bg-center" style="background-image: url('{{ $event->getFirstMediaUrl('event_posters') }}');">
            </div>
            ...
            <div class="p-8">
                ...
                <div class="mt-12">
                    <h2 class="text-3xl font-bold text-center text-gray-900 mb-8">Pilih Tiket Anda</h2>
